    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EmployeeNumber = table.Column<string>(type: "varchar(6)", maxLength: 6, nullable: false),
                    Id = table.Column<string>(type: "varchar(6)", maxLength: 6, nullable: true),
                    UserName = table.Column<string>(type: "varchar(20)", maxLength: 256, nullable: false),
                    EmployeeName = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    DepartmentId = table.Column<int>(type: "int", nullable: false),
                    PositionId = table.Column<int>(type: "int", nullable: false),
                    GenderCode = table.Column<string>(type: "char(1)", maxLength: 1, nullable: false),
                    ReportedToEmployeeNumber = table.Column<string>(type: "varchar(6)", maxLength: 6, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RequestId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RequestSubmissionDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    ...
                    ApprovedByEmployeeNumber = table.Column<string>(type: "varchar(6)", maxLength: 6, nullable: true),
                    DeclinedByEmployeeNumber = table.Column<string>(type: "varchar(6)", maxLength: 6, nullable: true)
                },
                constraints: table =>
                {
